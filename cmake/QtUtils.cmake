macro(msvc_registry_search)
	if(NOT DEFINED Qt5_DIR)
		...
		if(QT_MSVC)
			...
			elseif(EXISTS "../${QT_VERSION}")
				message(WARNING "1,${QT_VERSION},${QT_SUFFIX}")
			elseif(EXISTS "../../${QT_VERSION}")
				message(WARNING "2,${QT_VERSION},${QT_SUFFIX}")
			elseif(EXISTS "../../../${QT_VERSION}")
				message(WARNING "3,${QT_VERSION},${QT_SUFFIX}")
			else()
				message(WARNING "Required QT5 toolchain is not installed,${QT_VERSION},${QT_SUFFIX}")
			endif()
		endif()
	endif()
endmacro()
